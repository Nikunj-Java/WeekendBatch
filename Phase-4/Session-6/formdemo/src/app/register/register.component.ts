...
export class RegisterComponent implements OnInit {
  ...
  //inject formbuilder dependency to create form with validator
  ...
  //when user will click on submit button  -method prepared by me
  OnSubmit(){
  ...
  //to accesss form control in a view to display the error
  get f(){
